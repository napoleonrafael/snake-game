...
window.snapKitInit = function () {
  ...
  snap.loginkit.mountButton(loginButtonIconId, {
    clientId: '7bf89e21-928f-4c48-a3d4-9e7b35f7df88', /*YOU CHANGE: Must be changed to the development client ID on snapckit*/
    redirectURI: 'https://snake-squad-napoleon.glitch.me', /*YOU CHANGE: Must be changed to your glitch project's url AND added as the redirect URI on snapkit */
    scopeList: [
      'user.display_name',
      'user.bitmoji.avatar',
    ],
